                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input value="{{ old('username') }}" type="text" class="form-control @error('email') is-invalid @enderror" name="username" id="username" placeholder="username" >
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                            <a href="{{ route('auth.login.show') }}" class="link-secondary text-decoration-none">Click here to login</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
